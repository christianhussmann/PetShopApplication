namespace HussmannDev.PetShopApp.UI
{
    public class StringConstants
    {
        ...
        public const string CreateNewPetMessage = "Select 1 to Create a new Pet";
        public const string ShowAllPetsMenuText = "Select 2 to See All Pets";
        public const string DeletePetMessage = "Select 3 to delete a pet";
        public const string UpdatePetMessage = "Select 4 to edit the pet";
        public const string SortByPriceMessage = "Select 5 to sort the pets by price";
        public const string SearchByTypeMessage = "Select 6 to Search for  a specific type of pet";
