namespace HussmannDev.PetShopApp.UI
{
    ...
    {
        public static readonly string WelcomeGreeting = "Welcome to the Petshop App";
        ...
        public static readonly string ShowAllVideosMenuText = "Select 2 to See All available Videos";
        public static string DeletePromptMessage = "What id do you want to delete?";
